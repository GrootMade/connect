...
class Constants
{
	...
	const ADMIN_PAGE_ID = 'grootmade';

	const ADMIN_PAGE_TITLE = 'Grootmade';
	...
	const PLUGIN_DOWNLOAD_URL = 'https://raw.githubusercontent.com/GrootMade/connect/stable/grootmade.zip';
