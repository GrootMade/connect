# Contributing to Grootmade

First off, thank you for considering contributing to Grootmade! Your time and effort are greatly appreciated. By contributing, you help improve this plugin for everyone.
...
2. **Clone the Repository**: Clone your forked repository to your local machine using:
   ```bash
   git clone https://github.com/your-username/Grootmade.git
   ```
...
### Thank You!
Thank you for contributing to Grootmade! Your contributions make this project better for everyone.
